...
export class SharedDataService {
  ...
  getAccounts() {
    ...
    let accounts = ['Suntrust', 'Middleburg', 'Wells Fargo'];
    return accounts;
  }

  getColorCodes() {
    let colorCodes = ['Grey', 'Black', 'Red', 'Orange', 'Yellow', 'Green', 'Blue', 'Purple', 'Pink', 'Cornflower-Blue'];
    return colorCodes;
  }

  getCategories() {
    let categories = ['Rebalance', 'Tax Return', 'Offering', 'Cell', 'Utilities',
